<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            <input wire:keydown="limpiar_page" class="form-input flex-1 shadow-sm" placeholder="Ingrese el nombre de un curso." wire:model="search">
                   ...
                   <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                @else
                                <img class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/5553056/pexels-photo-5553056.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                                @endisset
                                </div>
                                <div class="ml-4">
